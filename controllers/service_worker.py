...
class ServiceWorker(PWA):
    ...
    JS_PWA_MAIN = """
        ...
        odoo.define("damsu_web_pwa.ServiceWorker", function (require) {{
            "use strict";
    ...
    def _get_js_pwa_requires(self):
        return """
            const PWA = require('damsu_web_pwa.PWA');
        """

    def _get_js_pwa_init(self):
        return """
            const damsu_pwa = new PWA({});
        """.format(
    ...
    def _get_js_pwa_core_event_install_impl(self):
        return """
            evt.waitUntil(damsu_pwa.installWorker());
            self.skipWaiting();
        """
    ...
    def _get_js_pwa_core_event_activate_impl(self):
        return """
            ...
            evt.waitUntil(damsu_pwa.activateWorker());
            self.clients.claim();
        """

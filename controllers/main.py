...
class PWA(Controller):
    def _get_pwa_scripts(self):
        ...
        return [
            ...
            "/damsu_web_pwa/static/src/js/worker/jquery-sw-compat.js",
            "/web/static/src/js/promise_extension.js",
            "/web/static/src/js/boot.js",
            "/web/static/src/js/core/class.js",
            "/damsu_web_pwa/static/src/js/worker/pwa.js",
        ]
    ...
    def _get_pwa_manifest_icons(self, pwa_icon):
        ...
        if not pwa_icon:
            for size in [
                ...
                icons.append(
                    {
                        "src": "/damsu_web_pwa/static/img/icons/icon-%sx%s.png"
    ...
    def _get_pwa_manifest(self):
        ...
        pwa_name = config_param_sudo.get_param("pwa.manifest.name", "Damsu PWA")
        pwa_short_name = config_param_sudo.get_param(
            "pwa.manifest.short_name", "Damsu PWA"
        )
        pwa_icon = (
            request.env["ir.attachment"]
            .sudo()
            .search([("url", "like", "/damsu_web_pwa/icon.")])
        )
    ...
    @route("/damsu_web_pwa/manifest.webmanifest", type="http", auth="public")
